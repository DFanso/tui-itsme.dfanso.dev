...
Captured from the real binary running in Windows Terminal:

<p align="center"><img src="docs/screenshots/real-startup.png" alt="Startup in Windows Terminal" width="900"></p>

| `github` (with `GITHUB_TOKEN`) | `projects` |
|---|---|
| ![github](docs/screenshots/real-github.png) | ![projects](docs/screenshots/real-projects.png) |

| `hack` | `matrix` |
|---|---|
| ![hack](docs/screenshots/real-hack.png) | ![matrix](docs/screenshots/real-matrix.png) |

Rendered frames (generated by the app's own renderer, always in sync with the code):
